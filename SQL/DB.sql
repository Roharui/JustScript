...
CREATE TABLE `recommend` (
  ...
  CONSTRAINT `_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`_id`),
  CONSTRAINT `id` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`)
...
INSERT INTO `recommend` VALUES (6,5,9,8),(8,5,9,9),(9,1,1,8),(10,1,1,9),(11,1,1,23);
...
INSERT INTO `user` VALUES (1,'test','1234',0,0,0,'MASTER','img/upload_file-1609509455705.jpg'),(2,'ABCD','WWWWWW',0,0,0,'TESTING','Icon.png'),(3,'test','WWWWWW',0,0,0,'TESTING','Icon.png'),(8,'ssss','ssss',0,0,0,'ssss','Icon.png'),(9,'jjjjjjjjjjjjjjj','12k3k12k3j1k2j3k12k31kj',0,0,0,'ROWABLE','Icon.png');
...
-- Dump completed on 2021-01-03 23:57:06
