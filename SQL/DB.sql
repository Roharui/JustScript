...
CREATE TABLE `recommend` (
  ...
  CONSTRAINT `_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`_id`) ON DELETE CASCADE,
  CONSTRAINT `id` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`) ON DELETE CASCADE
...
INSERT INTO `recommend` VALUES (6,5,9,8),(8,5,9,9),(9,1,1,8),(10,1,1,9),(11,0,1,23),(12,1,1,16),(14,1,1,11);
...
CREATE TABLE `user` (
  ...
  `profile_img` varchar(45) NOT NULL DEFAULT 'img/default_img.jpg',
...
INSERT INTO `user` VALUES (1,'test','1234',0,0,0,'MASTER','img/upload_file-1609509455705.jpg',1),(2,'ABCD','WWWWWW',0,0,0,'TESTING','Icon.png',0),(3,'test','WWWWWW',0,0,0,'TESTING','Icon.png',0),(8,'ssss','ssss',0,0,0,'ssss','Icon.png',0),(9,'jjjjjjjjjjjjjjj','12k3k12k3j1k2j3k12k31kj',0,0,0,'ROWABLE','Icon.png',0),(10,'FFF','qwertyuiop',0,0,0,'R','img/default_img.jpg',0);
...
-- Dump completed on 2021-01-10 23:30:24
